...
public class TileTransporterRenderer extends TileEntitySpecialRenderer{
	...
	public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float var8) {
		TileTransporter base = (TileTransporter)tile;
		renderInput(base, x, y, z);
		renderOutput(base, x, y, z);
	}
	
	public void renderInput(TileTransporter base, double x, double y, double z){
	...
	public void renderOutput(TileTransporter base, double x, double y, double z){
		Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("modularmachines:textures/misc/indicator.png"));
		OpenGlHelper.setActiveTexture(OpenGlHelper.lightmapTexUnit);
		GL11.glDisable(GL11.GL_TEXTURE_2D);
		OpenGlHelper.setActiveTexture(OpenGlHelper.defaultTexUnit);
