...
public class HeatedPickaxe extends ItemPickaxe implements IHeatContainer, IHeatedTool{

	public HeatedPickaxe(String name){
    ...
    public void registerIcons(IIconRegister ir){
        itemIcon = ir.registerIcon(LibMod.modName.toLowerCase() + ":" + "pickaxe_heated");
	}
