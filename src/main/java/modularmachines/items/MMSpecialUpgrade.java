...
public class MMSpecialUpgrade extends Item{

	public MMSpecialUpgrade(String name, int color) {
		setMaxStackSize(1);
	...
	{
		itemIcon = ir.registerIcon(LibMod.modName.toLowerCase() + ":" + "upgrade_special");
	}
}